...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      settingsSubtitle: "Configure how the app behaves on your desktop.",
      ...
      remoteSshSubtitle: "Manage one-click SSH tunnels for remote AI coding sessions. Profiles never store passwords or passphrases — the app relies on your existing ssh-agent / SSH keys.",
      ...
      remoteSshErrNoLocalPort: "The local app service is not yet running.",
      remoteSshErrUnknownStrikes: "Multiple unrecognized errors in a row — please check the profile and logs.",
      remoteSshProbeLocalUnhealthy: "Tunnel established but the local app service is not healthy.",
      remoteSshProbeUnresponsive: "Tunnel established but the app service is not responding. Make sure the app is running.",
      ...
      remoteSshConnectWarnNoDeploy: "Hooks are not deployed yet. Connect alone only builds the SSH tunnel — the app will not react to remote sessions until you click Deploy / Repair Hooks.",
      ...
      doctorSidebarLabel: "Status",
      doctorTitle: "Status",
      doctorStatusUnknown: "Unknown",
      doctorStatusPass: "OK",
      doctorStatusWarning: "Needs attention",
      doctorStatusCritical: "Action required",
      ...
      doctorPrivacy: "Privacy notice: this report is generated locally. This app does not upload data. User paths and secrets are redacted before copying.",
      ...
      doctorFixConfirmCodex: "This app will set [features].hooks = true in your Codex config. Continue?",
      doctorFixConfirmCodexTitle: "Enable Codex hooks?",
      doctorFixConfirmCodexDetail: "This repair will change your Codex config and set [features].hooks = true. This app will not make that change unless you confirm it here.",
      doctorFixConfirmCodexAction: "Enable and repair",
      doctorFixConfirmCancel: "Cancel",
      doctorRestartButton: "Restart app",
      doctorRestarting: "Restarting",
      doctorRestartConfirmTitle: "Restart app?",
      doctorRestartConfirmDetail: "The app will close and reopen. In-flight requests from your AI coding agents will be dropped. The Settings window will close as part of the restart.",
      ...
      shortcutLabelTogglePet: "Show/hide Pet",
      ...
      rowAgentPermissionsDesc: "Turn off to let this agent handle prompts in its own terminal instead of showing an app bubble.",
      rowCodexPermissionMode: "Codex permission mode",
      rowCodexPermissionModeDesc: "Native keeps Codex AutoReview and terminal prompts in charge. Intercept shows app Allow/Deny bubbles.",
      ...
      rowSoundDesc: "Play a chime when the app finishes a task or asks for input.",
      rowVolume: "Volume",
      rowVolumeDesc: "Adjust sound effect volume. Disabled when sound effects are off.",
      rowLowPowerIdleMode: "Low power idle",
      rowLowPowerIdleModeDesc: "Pause idle SVG animation after the pet has been still for a few seconds; activity resumes animation immediately.",
      ...
      rowOpenAtLoginDesc: "Start the app automatically when you log in.",
      ...
      claudeHooksDisconnectConfirmDetail: "This removes app-managed Claude hooks from ~/.claude/settings.json and turns off automatic management. Start with Claude Code will be kept for later re-enable.",
      ...
      rowStartWithClaudeDesc: "Auto-launch the app whenever a Claude Code session starts.",
      ...
      rowHideBubblesDesc: "Hide permission, notification, and update bubbles across the app.",
      ...
      updateBubbleDisableConfirmDetail: "You may miss update failures, download-complete messages, and restart prompts. The update flow itself will still run, but the app will not show update bubbles.",
      ...
      placeholderDesc: "This panel will land in a future app release. The plan lives in docs/plans/plan-settings-panel.md.",
      ...
      langJapanese: "日本語",
      themeTitle: "Theme",
      themeSubtitle: "Pick a theme for the pet. Cards show built-in + capability badges so you can see tracked/static/mini differences before switching.",
      ...
      themeImportUserThemeZip: "Import pet theme package (.zip)",
      themeImportUserThemeZipHint: "Pet theme zip: root or one top-level folder must contain theme.json. Put SVG, GIF, APNG, PNG, WebP, JPG, or JPEG assets in assets/. Use Codex Pet import for Codex Pet packages.",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pets refreshed: ${imported} new, ${updated} updated, ${unchanged} unchanged, ${removed} removed${invalid ? `, ${invalid} invalid` : ""}${switched ? "; active theme reset to the default theme" : ""}.`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `Uninstalled "${name}"${switched ? " and switched back to the default theme" : ""}.`,
      toastCodexPetRemoveFailed: (message) => `Couldn't uninstall imported pet: ${message}`,
      animMapTitle: "Animation Map",
      animMapSubtitle: "Silence individual interrupt animations. Events still fire — the app just skips the visual and sound for the selected states.",
      ...
      aboutEasterEggToast: "Local AI, always on your desk.",
      aboutOpenExternalFailed: "Couldn't open the link in your browser.",
    },
    zh: {
      settingsTitle: "设置",
      settingsSubtitle: "配置应用在桌面上的行为。",
      sidebarGeneral: "通用",
      ...
      remoteSshSubtitle: "管理一键 SSH 隧道，让远程 AI 编码会话像本地一样工作。应用不存任何密码或私钥口令——依赖你已配置的 ssh-agent / SSH 密钥。",
      ...
      remoteSshErrNoLocalPort: "本地应用服务尚未启动。",
      remoteSshErrUnknownStrikes: "连续多次未识别错误，请检查配置和日志。",
      remoteSshProbeLocalUnhealthy: "隧道已建立但本地应用服务异常。",
      remoteSshProbeUnresponsive: "隧道已建立但应用服务无响应，请确认应用在运行。",
      ...
      remoteSshConnectWarnNoDeploy: "Hook 文件还没部署。Connect 只建 SSH 隧道，不部署 hook——必须点 Deploy / Repair Hooks 之后应用才会响应远端会话。",
      codexHookReviewReminder: "下一步：打开 Codex 命令行，输入 /hooks 走一遍 review 激活新 hook（Codex 要求 review 后才会触发）。",
      doctorSidebarLabel: "状态",
      doctorTitle: "运行状态",
      doctorStatusUnknown: "未知",
      doctorStatusPass: "正常",
      doctorStatusWarning: "需注意",
      doctorStatusCritical: "需处理",
      doctorStatusInfo: "提示",
      ...
      doctorPrivacy: "隐私说明：诊断报告只在本机生成，本应用不会上传数据。复制前会脱敏用户路径和密钥。",
      ...
      doctorFixConfirmCodex: "本应用会把 Codex 配置里的 [features].hooks 设为 true。继续吗？",
      doctorFixConfirmCodexTitle: "启用 Codex hooks？",
      doctorFixConfirmCodexDetail: "这次修复会修改你的 Codex 配置，把 [features].hooks 设为 true。只有你在这里确认后，本应用才会做这个改动。",
      doctorFixConfirmCodexAction: "启用并修复",
      doctorFixConfirmCancel: "取消",
      doctorRestartButton: "重启应用",
      doctorRestarting: "重启中",
      doctorRestartConfirmTitle: "重启应用？",
      doctorRestartConfirmDetail: "应用会关闭并重新启动。AI coding agent 正在进行的请求会被中断。重启过程中设置窗口也会一并关闭。",
      ...
      shortcutLabelTogglePet: "显示/隐藏Pet",
      ...
      rowAgentPermissionsDesc: "关闭后让该 agent 在自己的终端里处理提示，不再弹应用气泡。",
      rowCodexPermissionMode: "Codex 权限模式",
      rowCodexPermissionModeDesc: "Native 保持 Codex AutoReview 和终端原生提示接管；Intercept 显示应用允许/拒绝气泡。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      ...
      rowSoundDesc: "应用完成任务或需要输入时播放提示音。",
      rowVolume: "音量",
      rowVolumeDesc: "调整音效音量。关闭音效时不可用。",
      rowLowPowerIdleMode: "低功耗 idle",
      rowLowPowerIdleModeDesc: "桌宠静止几秒后暂停 idle SVG 动画；有活动时会立即恢复动画。",
      ...
      rowOpenAtLogin: "开机自启",
      rowOpenAtLoginDesc: "登录系统时自动启动应用。",
      ...
      claudeHooksDisconnectConfirmDetail: "这会从 `~/.claude/settings.json` 移除应用管理的 Claude hooks，并关闭自动管理。`随 Claude Code 启动` 的偏好会保留，方便以后重新启用。",
      claudeHooksDisconnectConfirmAction: "断开 hooks",
      claudeHooksDisconnectConfirmKeep: "继续保留",
      rowStartWithClaude: "随 Claude Code 启动",
      rowStartWithClaudeDesc: "Claude Code 会话开始时自动拉起应用。",
      rowStartWithClaudeDisabledDesc: "需要先开启 Claude hooks 自动管理。关闭期间，端口变化和外部覆盖都不会被自动修补。",
      rowHideBubbles: "隐藏气泡",
      rowHideBubblesDesc: "隐藏应用的权限、通知和更新气泡。",
      ...
      updateBubbleDisableConfirmDetail: "隐藏后可能错过更新失败原因、下载完成提示和重启安装提示。更新流程本身仍会继续，但应用不再显示更新气泡。",
      ...
      placeholderDesc: "此面板将在后续版本中加入，规划见 docs/plans/plan-settings-panel.md。",
      ...
      langJapanese: "日本語",
      themeTitle: "主题",
      themeSubtitle: "为桌宠选择一个主题。卡片会显示内建和能力角标，切换前就能看出 tracked / static / mini 等差异。",
      themeEmpty: "没有可用的主题。",
      ...
      themeImportUserThemeZip: "导入桌宠主题包（.zip）",
      themeImportUserThemeZipHint: "桌宠主题 zip：根目录或一个顶层文件夹内必须包含 theme.json；素材放在 assets/，可使用 SVG、GIF、APNG、PNG、WebP、JPG、JPEG。Codex Pet 包请用上方入口。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet 已刷新：新增 ${imported}，更新 ${updated}，未变 ${unchanged}，移除 ${removed}${invalid ? `，无效 ${invalid}` : ""}${switched ? "；当前主题已回退到默认主题" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `已卸载 "${name}"${switched ? "，并切回默认主题" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `卸载导入宠物失败：${message}`,
      animMapTitle: "动画映射",
      animMapSubtitle: "关掉不想看的打扰动画。事件照样会触发——应用只是不再播放对应的动画和音效。",
      ...
      minicpmIpcUnavailable: "MiniCPM IPC 不可用（preload 未加载）。",
      ...
      minicpmBackendVulkan: "Vulkan",
      minicpmBackendMetal: "Metal",
      minicpmBackendVulkanExperimental: "实验 GPU 后端",
      minicpmBackendVulkanFallback: "Vulkan 启动失败，已回退 CPU。",
      minicpmRowModelInfo: "模型",
      minicpmRowModelPath: "路径",
      minicpmModelPathUnset: "未选择模型",
      minicpmOpenModelPath: "在访达中显示",
      minicpmOpenModelDirFailed: "无法打开模型目录。",
      ...
      minicpmActionRestartSidecarDesc: "应用模型 / 加速器变更",
      minicpmActionRestartSidecarBusy: "重启中…",
      minicpmActionOpenLogs: "打开日志目录",
      minicpmActionOpenLogsDesc: "排查 Sidecar / llama 启动问题",
      minicpmActionOpenLogsFailed: "无法打开日志目录。",
      ...
      minicpmAdapterOpenDirFailed: "无法打开 adapters 目录。",
      minicpmAdapterUpload: "上传 LoRA",
      minicpmAdapterUploadFailed: "上传 LoRA 失败：",
      minicpmAdapterDisplayNameLabel: "显示名称",
      minicpmAdapterDisplayNamePlaceholder: "例如：猫娘 宝宝",
      minicpmAdapterAliasesLabel: "别名（逗号分隔）",
      minicpmAdapterAliasesPlaceholder: "例如：猫娘, 宝宝, neko",
      minicpmAdapterEditName: "编辑名称与别名",
      minicpmAdapterRemove: "删除",
      minicpmAdapterRemoveConfirm: "确定删除这个 LoRA？对应的 .gguf 文件也会被删掉。",
      minicpmAdapterMissingTag: "文件丢失",
      minicpmAdapterSaveFailed: "保存失败：",
      minicpmAdapterSave: "保存",
      minicpmAdapterCancel: "取消",
      ...
      aboutEasterEggToast: "本地 AI，一直在你桌面上。",
      aboutOpenExternalFailed: "无法在浏览器中打开链接。",
    },
    "zh-TW": {
      settingsTitle: "設定",
      settingsSubtitle: "設定應用程式在桌面上的動作。",
      sidebarGeneral: "一般",
      sidebarAgents: "Agent 管理",
      sidebarTheme: "主題",
      sidebarAnimMap: "動畫對應",
      ...
      remoteSshSubtitle: "管理一鍵 SSH 通道，讓遠端 AI 程式設計工作階段像在本機一樣順手。應用程式不會留下任何密碼或私鑰通行片語——靠你已經設好的 ssh-agent 或 SSH 金鑰。",
      ...
      remoteSshErrNoLocalPort: "本機應用程式服務尚未啟動。",
      remoteSshErrUnknownStrikes: "連續多次無法識別錯誤，請檢查設定和記錄檔。",
      remoteSshProbeLocalUnhealthy: "通道已建立，但本機應用程式服務狀態異常。",
      remoteSshProbeUnresponsive: "通道已建立，但 應用程式服務沒有回應，請確認應用程式是否正在執行。",
      ...
      remoteSshHooksDeployedAgoDay: "{n} 天前部署",
      remoteSshConnectWarnNoDeploy: "Hook 檔案還沒部署。Connect 只接 SSH 通道、不會部署 hook——要先點 Deploy / Repair Hooks，應用程式才會回應遠端工作階段。",
      codexHookReviewReminder: "下一步：開啟 Codex 命令列，輸入 /hooks 走一遍 review，新 hook 才會啟用（Codex 規定 review 後才會觸發）。",
      doctorSidebarLabel: "狀態",
      doctorTitle: "執行狀態",
      doctorStatusUnknown: "未知",
      doctorStatusPass: "正常",
      doctorStatusWarning: "需注意",
      doctorStatusCritical: "需處理",
      doctorStatusInfo: "提示",
      ...
      doctorPrivacy: "隱私權聲明：診斷報告只在本機產生，本應用不會上傳任何資料。複製前會自動把使用者路徑和金鑰遮起來。",
      ...
      doctorFixConfirmCodex: "本應用會把 Codex 設定裡的 [features].hooks 改成 true。要繼續嗎？",
      doctorFixConfirmCodexTitle: "啟用 Codex hooks？",
      doctorFixConfirmCodexDetail: "這次修復會更動你的 Codex 設定，把 [features].hooks 改成 true。除非你在這裡確認，否則本應用不會更動。",
      doctorFixConfirmCodexAction: "啟用並修復",
      doctorFixConfirmCancel: "取消",
      doctorRestartButton: "重新啟動應用",
      doctorRestarting: "重新啟動中",
      doctorRestartConfirmTitle: "重新啟動應用？",
      doctorRestartConfirmDetail: "應用會關掉再開起來。AI coding agent 還在跑的請求會被中斷。重新啟動時設定視窗也會一併關閉。",
      ...
      shortcutLabelTogglePet: "顯示/隱藏Pet",
      ...
      rowAgentPermissionsDesc: "關掉以後，這個 agent 會改由自己的終端機處理提示，不會再彈 應用程式對話框。",
      rowCodexPermissionMode: "Codex 權限模式",
      rowCodexPermissionModeDesc: "Native 維持 Codex AutoReview 和終端機原本的提示；Intercept 改成顯示 應用程式的允許或拒絕對話框。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      ...
      rowSoundDesc: "應用程式完成任務或要等輸入時會播放提示聲。",
      rowVolume: "音量",
      rowVolumeDesc: "調整音效音量。停用音效後無法使用。",
      rowLowPowerIdleMode: "低耗電閒置狀態",
      rowLowPowerIdleModeDesc: "桌寵不動幾秒後就暫停閒置狀態 SVG 動畫；有活動時立即恢復。",
      ...
      rowOpenAtLoginDesc: "登入系統時自動啟動應用程式。",
      ...
      claudeHooksDisconnectConfirmDetail: "這會從 `~/.claude/settings.json` 移除 應用程式管理的 Claude hooks，並關掉自動管理。「隨 Claude Code 啟動」的偏好會保留，方便之後再開啟。",
      claudeHooksDisconnectConfirmAction: "中斷 hooks 連線",
      claudeHooksDisconnectConfirmKeep: "繼續保留",
      rowStartWithClaude: "隨 Claude Code 啟動",
      rowStartWithClaudeDesc: "Claude Code 工作階段一開始就自動把應用程式叫起來。",
      rowStartWithClaudeDisabledDesc: "要先開啟 Claude hooks 自動管理。關掉的時候，連接埠變動和外部更動都不會自動修。",
      rowHideBubbles: "隱藏對話框",
      rowHideBubblesDesc: "隱藏應用程式的權限、通知和更新對話框。",
      rowBubbleFollow: "對話框跟著桌寵",
      ...
      updateBubbleDisableConfirmDetail: "隱藏後可能會錯過更新失敗原因、下載完成提示和重新啟動安裝提示。更新流程本身還是會繼續，只是 應用程式不再顯示更新對話框。",
      ...
      placeholderDesc: "這個面板會在後續版本加入，規劃見 docs/plans/plan-settings-panel.md。",
      ...
      langJapanese: "日本語",
      themeTitle: "主題",
      themeSubtitle: "幫桌寵選擇主題。主題卡會顯示是否為內建主題，以及游標跟隨、靜態、迷你模式等支援項目，方便切換前比較差異。",
      themeEmpty: "沒有主題可以用。",
      ...
      themeImportUserThemeZip: "匯入桌寵主題套件（.zip）",
      themeImportUserThemeZipHint: "桌寵主題 zip：根目錄或單一頂層資料夾裡要有 theme.json；素材放在 assets/，支援 SVG、GIF、APNG、PNG、WebP、JPG、JPEG。Codex Pet 套件請改用上面的入口。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet 已重新整理：新增 ${imported}，更新 ${updated}，沒變 ${unchanged}，移除 ${removed}${invalid ? `，無效 ${invalid}` : ""}${switched ? "；目前主題已切回預設主題" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `已解除安裝「${name}」${switched ? "，並切回預設主題" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `解除安裝匯入的寵物失敗：${message}`,
      animMapTitle: "動畫對應",
      animMapSubtitle: "關掉不想看的打擾動畫。事件還是會觸發——應用程式只是不再播對應的動畫和音效。",
      ...
      minicpmTitle: "MiniCPM",
      minicpmSubtitle: "設定你的本地 MiniCPM 模型。",
      minicpmIpcUnavailable: "MiniCPM IPC 無法使用（preload 未載入）。",
      minicpmSectionBehavior: "行為",
      minicpmSectionModel: "模型",
      minicpmSectionAdvanced: "進階設定",
      minicpmRowNarration: "桌寵旁白",
      minicpmRowNarrationDesc: "Cursor / Claude / Codex 事件觸發時，桌寵會以本地模型主動說話。",
      minicpmRowDefaultThinking: "預設思考模式",
      minicpmRowDefaultThinkingDesc: "開啟後，新對話將預設啟用思考模式。回應時間與本地資源占用將有所增加。",
      minicpmRowBackend: "推論後端",
      minicpmRowBackendDesc: "Windows 預設使用較穩定的 CPU。Vulkan 是實驗功能，失敗會自動回到 CPU。",
      minicpmBackendCpu: "CPU",
      minicpmBackendVulkan: "Vulkan",
      minicpmBackendMetal: "Metal",
      minicpmBackendVulkanExperimental: "實驗 GPU 後端",
      minicpmBackendVulkanFallback: "Vulkan 啟動失敗，已回到 CPU。",
      minicpmRowModelInfo: "模型",
      minicpmRowModelPath: "路徑",
      minicpmModelPathUnset: "未選擇模型",
      minicpmOpenModelPath: "在 Finder 中顯示",
      minicpmOpenModelDirFailed: "無法打開模型目錄。",
      minicpmChangeModel: "更換…",
      minicpmChangeModelBusy: "載入中…",
      minicpmReloadError: "模型載入失敗：",
      minicpmStatusRunning: "執行中",
      minicpmStatusStarting: "啟動中",
      minicpmStatusError: "異常",
      minicpmActionRestartSidecar: "重新啟動 Sidecar",
      minicpmActionRestartSidecarDesc: "套用模型 / 加速器變更",
      minicpmActionRestartSidecarBusy: "重新啟動中…",
      minicpmActionOpenLogs: "打開日誌目錄",
      minicpmActionOpenLogsDesc: "排查 Sidecar / llama 啟動問題",
      minicpmActionOpenLogsFailed: "無法打開日誌目錄。",
      minicpmSectionAdapter: "人格 LoRA",
      minicpmRowAdapter: "目前 LoRA",
      minicpmRowAdapterDesc: "切換桌寵人格；旁白固定走 base 模型。",
      minicpmAdapterBase: "Base",
      minicpmAdapterEmpty: "adapters 目錄裡還沒有 .gguf 檔案。",
      minicpmAdapterOpenDir: "打開儲存目錄",
      minicpmAdapterRefresh: "重新整理",
      minicpmAdapterApplying: "切換中…",
      minicpmAdapterApplyFailed: "切換 LoRA 失敗：",
      minicpmAdapterOpenDirFailed: "無法打開 adapters 目錄。",
      minicpmAdapterUpload: "上傳 LoRA",
      minicpmAdapterUploadFailed: "上傳 LoRA 失敗：",
      minicpmAdapterDisplayNameLabel: "顯示名稱",
      minicpmAdapterDisplayNamePlaceholder: "例如：貓娘 寶寶",
      minicpmAdapterAliasesLabel: "別名（逗號分隔）",
      minicpmAdapterAliasesPlaceholder: "例如：貓娘, 寶寶, neko",
      minicpmAdapterEditName: "編輯名稱與別名",
      minicpmAdapterRemove: "刪除",
      minicpmAdapterRemoveConfirm: "確定刪除這個 LoRA？對應的 .gguf 檔案也會被刪掉。",
      minicpmAdapterMissingTag: "檔案遺失",
      minicpmAdapterSaveFailed: "儲存失敗：",
      minicpmAdapterSave: "儲存",
      minicpmAdapterCancel: "取消",
    ...
    ko: {
      settingsTitle: "설정",
      settingsSubtitle: "데스크톱에서 앱의 동작 방식을 설정합니다.",
      sidebarGeneral: "일반",
      sidebarAgents: "에이전트",
      sidebarTheme: "테마",
      ...
      remoteSshSubtitle: "원클릭 SSH 터널을 관리해 원격 AI 코딩 세션을 매끄럽게 사용하세요. 앱은 비밀번호나 패스프레이즈를 저장하지 않으며, 기존 ssh-agent / SSH 키를 사용합니다.",
      ...
      remoteSshErrNoLocalPort: "로컬 앱 서비스가 아직 시작되지 않았습니다.",
      remoteSshErrUnknownStrikes: "인식할 수 없는 오류가 연속 발생했습니다. 프로필과 로그를 확인하세요.",
      remoteSshProbeLocalUnhealthy: "터널은 연결되었지만 로컬 앱 서비스가 비정상입니다.",
      remoteSshProbeUnresponsive: "터널은 연결되었지만 앱 서비스가 응답하지 않습니다. 앱이 실행 중인지 확인하세요.",
      ...
      remoteSshConnectWarnNoDeploy: "Hook 파일이 아직 배포되지 않았습니다. Connect는 SSH 터널만 구축하므로, Deploy / Repair Hooks를 눌러야 원격 세션에 앱이 반응합니다.",
      codexHookReviewReminder: "다음 단계: Codex CLI를 열고 /hooks를 실행해 새 후크를 검토하고 활성화하세요(Codex가 검토 후에만 후크를 실행합니다).",
      doctorSidebarLabel: "상태",
      doctorTitle: "실행 상태",
      doctorStatusUnknown: "알 수 없음",
      doctorStatusPass: "정상",
      doctorStatusWarning: "확인 필요",
      doctorStatusCritical: "조치 필요",
      doctorStatusInfo: "정보",
      ...
      doctorPrivacy: "개인정보 안내: 진단 보고서는 로컬에서 생성됩니다. 이 앱은 데이터를 업로드하지 않으며 복사 전에 사용자 경로와 비밀값을 가립니다.",
      ...
      doctorFixConfirmCodex: "이 앱이 Codex 설정의 [features].hooks를 true로 변경합니다. 계속할까요?",
      doctorFixConfirmCodexTitle: "Codex hooks를 켤까요?",
      doctorFixConfirmCodexDetail: "이 복구는 Codex 설정의 [features].hooks를 true로 변경합니다. 여기에서 확인하기 전에는 이 앱이 이 변경을 하지 않습니다.",
      doctorFixConfirmCodexAction: "켜고 복구",
      doctorFixConfirmCancel: "취소",
      doctorRestartButton: "앱 재시작",
      doctorRestarting: "재시작 중",
      doctorRestartConfirmTitle: "앱을 재시작할까요?",
      doctorRestartConfirmDetail: "앱이 종료된 뒤 다시 실행됩니다. 진행 중인 AI 코딩 에이전트 요청은 중단됩니다. 재시작 중에는 설정 창도 함께 닫힙니다.",
      ...
      shortcutLabelTogglePet: "Pet 표시/숨기기",
      ...
      rowAgentPermissionsDesc: "끄면 이 에이전트는 앱 말풍선 대신 자체 터미널에서 프롬프트를 처리합니다.",
      rowCodexPermissionMode: "Codex 권한 모드",
      rowCodexPermissionModeDesc: "Native는 Codex AutoReview와 터미널 프롬프트를 그대로 사용합니다. Intercept는 앱 허용/거부 말풍선을 표시합니다.",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      ...
      rowSoundDesc: "앱이 작업을 마치거나 입력을 요청할 때 알림음을 재생합니다.",
      rowVolume: "볼륨",
      rowVolumeDesc: "효과음 볼륨을 조절합니다. 효과음이 꺼져 있을 때는 비활성화됩니다.",
      rowLowPowerIdleMode: "저전력 idle",
      rowLowPowerIdleModeDesc: "펫이 몇 초 동안 가만히 있으면 idle SVG 애니메이션을 일시 중지하고, 활동이 있으면 즉시 다시 재생합니다.",
      ...
      rowOpenAtLoginDesc: "로그인할 때 앱을 자동으로 시작합니다.",
      ...
      claudeHooksDisconnectConfirmDetail: "`~/.claude/settings.json`에서 앱이 관리하는 Claude hooks를 제거하고 자동 관리를 끕니다. `Claude Code와 함께 시작` 설정은 나중에 다시 켤 수 있도록 유지됩니다.",
      ...
      rowStartWithClaudeDesc: "Claude Code 세션이 시작될 때마다 앱을 자동으로 실행합니다.",
      ...
      rowHideBubblesDesc: "앱의 권한, 알림, 업데이트 말풍선을 숨깁니다.",
      rowBubbleFollow: "말풍선이 펫을 따라다님",
      ...
      updateBubbleDisableConfirmDetail: "업데이트 실패 원인, 다운로드 완료 메시지, 재시작 안내를 놓칠 수 있습니다. 업데이트 흐름은 계속 실행되지만 앱은 업데이트 말풍선을 표시하지 않습니다.",
      ...
      placeholderDesc: "이 패널은 향후 앱 릴리스에 추가됩니다. 계획은 docs/plans/plan-settings-panel.md에 있습니다.",
      toastSaveFailed: "저장 실패: ",
      langSystem: "시스템 언어 따르기",
      langEnglish: "English",
      langChinese: "简中",
      langTraditionalChinese: "繁中",
      langKorean: "한국어",
      langJapanese: "日本語",
      themeTitle: "테마",
      themeSubtitle: "펫의 테마를 선택합니다. 카드에는 기본 제공/능력 배지가 표시되어 tracked/static/mini 차이를 미리 볼 수 있습니다.",
      ...
      themeImportUserThemeZip: "펫 테마 패키지 가져오기 (.zip)",
      themeImportUserThemeZipHint: "펫 테마 zip: 루트 또는 하나의 최상위 폴더에 theme.json이 있어야 합니다. SVG, GIF, APNG, PNG, WebP, JPG, JPEG 파일은 assets/에 넣으세요. Codex Pet 패키지는 위의 가져오기를 사용하세요.",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet을 새로고침했습니다: 신규 ${imported}, 업데이트 ${updated}, 변경 없음 ${unchanged}, 제거 ${removed}${invalid ? `, 무효 ${invalid}` : ""}${switched ? "; 활성 테마를 기본 테마로 되돌림" : ""}.`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `"${name}"을(를) 제거했습니다${switched ? " (기본 테마로 전환됨)" : ""}.`,
      toastCodexPetRemoveFailed: (message) => `가져온 펫을 제거하지 못했습니다: ${message}`,
      animMapTitle: "애니메이션 맵",
      animMapSubtitle: "개별 인터럽트 애니메이션을 끕니다. 이벤트는 계속 발생하지만 앱은 선택한 상태의 화면과 소리만 건너뜁니다.",
      ...
      minicpmTitle: "MiniCPM",
      minicpmSubtitle: "로컬 MiniCPM 모델을 설정합니다.",
      minicpmIpcUnavailable: "MiniCPM IPC를 사용할 수 없습니다(preload가 로드되지 않음).",
      minicpmSectionBehavior: "동작",
      minicpmSectionModel: "모델",
      minicpmSectionAdvanced: "고급",
      minicpmRowNarration: "펫 내레이션",
      minicpmRowNarrationDesc: "Cursor, Claude, Codex 이벤트가 발생하면 펫이 로컬 모델로 말합니다.",
      minicpmRowDefaultThinking: "기본 사고 모드",
      minicpmRowDefaultThinkingDesc: "켜면 새 대화에서 기본적으로 사고 모드를 사용합니다. 응답 시간과 로컬 리소스 사용량이 증가합니다.",
      minicpmRowBackend: "추론 백엔드",
      minicpmRowBackendDesc: "Windows는 안정적인 CPU가 기본입니다. Vulkan은 실험 기능이며 실패 시 CPU로 자동 전환됩니다.",
      minicpmBackendCpu: "CPU",
      minicpmBackendVulkan: "Vulkan",
      minicpmBackendMetal: "Metal",
      minicpmBackendVulkanExperimental: "실험적 GPU 백엔드",
      minicpmBackendVulkanFallback: "Vulkan 시작에 실패해 CPU로 전환했습니다.",
      minicpmRowModelInfo: "모델",
      minicpmRowModelPath: "경로",
      minicpmModelPathUnset: "선택된 모델 없음",
      minicpmOpenModelPath: "Finder에서 보기",
      minicpmOpenModelDirFailed: "모델 폴더를 열 수 없습니다.",
      minicpmChangeModel: "변경…",
      minicpmChangeModelBusy: "로딩 중…",
      minicpmReloadError: "모델 로드 실패: ",
      minicpmStatusRunning: "실행 중",
      minicpmStatusStarting: "시작 중",
      minicpmStatusError: "오류",
      minicpmActionRestartSidecar: "Sidecar 재시작",
      minicpmActionRestartSidecarDesc: "모델 / 가속기 변경 적용",
      minicpmActionRestartSidecarBusy: "재시작 중…",
      minicpmActionOpenLogs: "로그 폴더 열기",
      minicpmActionOpenLogsDesc: "Sidecar / llama 시작 문제 해결",
      minicpmActionOpenLogsFailed: "로그 폴더를 열 수 없습니다.",
      minicpmSectionAdapter: "페르소나 LoRA",
      minicpmRowAdapter: "활성 LoRA",
      minicpmRowAdapterDesc: "페르소나를 선택하세요. 내레이션은 항상 베이스 모델을 사용합니다.",
      minicpmAdapterBase: "Base",
      minicpmAdapterEmpty: "adapters 폴더에 .gguf 파일이 없습니다.",
      minicpmAdapterOpenDir: "저장 폴더 열기",
      minicpmAdapterRefresh: "새로 고침",
      minicpmAdapterApplying: "전환 중…",
      minicpmAdapterApplyFailed: "LoRA 전환 실패: ",
      minicpmAdapterOpenDirFailed: "adapters 폴더를 열 수 없습니다.",
      minicpmAdapterUpload: "LoRA 업로드",
      minicpmAdapterUploadFailed: "LoRA 업로드 실패: ",
      minicpmAdapterDisplayNameLabel: "표시 이름",
      minicpmAdapterDisplayNamePlaceholder: "예: 고양이 소녀 바오바오",
      minicpmAdapterAliasesLabel: "별칭 (쉼표 구분)",
      minicpmAdapterAliasesPlaceholder: "예: 고양이, 바오바오, neko",
      minicpmAdapterEditName: "이름·별칭 편집",
      minicpmAdapterRemove: "삭제",
      minicpmAdapterRemoveConfirm: "이 LoRA를 삭제할까요? .gguf 파일도 함께 삭제됩니다.",
      minicpmAdapterMissingTag: "파일 없음",
      minicpmAdapterSaveFailed: "저장 실패: ",
      minicpmAdapterSave: "저장",
      minicpmAdapterCancel: "취소",
      ...
      aboutEasterEggToast: "로컬 AI, 항상 책상 위에.",
      aboutOpenExternalFailed: "링크를 브라우저에서 열 수 없습니다.",
    },
    ja: {
      settingsTitle: "設定",
      settingsSubtitle: "アプリのデスクトップでの動作を設定します。",
      sidebarGeneral: "一般",
      ...
      remoteSshSubtitle: "ワンクリック SSH トンネルを管理し、リモートの AI コーディングセッションをローカルのように扱えます。アプリはパスワードやパスフレーズを保存せず、既存の ssh-agent / SSH キーを使います。",
      ...
      remoteSshErrNoLocalPort: "ローカルアプリサービスがまだ起動していません。",
      remoteSshErrUnknownStrikes: "認識できないエラーが連続して発生しました。プロフィールとログを確認してください。",
      remoteSshProbeLocalUnhealthy: "トンネルは確立しましたがローカルアプリサービスが異常です。",
      remoteSshProbeUnresponsive: "トンネルは確立しましたが アプリサービスが応答しません。アプリが起動しているか確認してください。",
      ...
      remoteSshConnectWarnNoDeploy: "Hook ファイルがまだデプロイされていません。Connect は SSH トンネルを張るだけなので、Deploy / Repair Hooks を押さないとリモートセッションにアプリが反応しません。",
      codexHookReviewReminder: "次のステップ：Codex CLI を開いて /hooks を実行し、新しいフックをレビューして有効化してください（Codex はレビュー後にのみ実行します）。",
      doctorSidebarLabel: "ステータス",
      doctorTitle: "実行ステータス",
      doctorStatusUnknown: "不明",
      doctorStatusPass: "正常",
      doctorStatusWarning: "要確認",
      doctorStatusCritical: "要対応",
      doctorStatusInfo: "情報",
      ...
      doctorPrivacy: "プライバシー: この診断レポートはローカルで生成されます。本アプリはデータをアップロードしません。コピー前にユーザーパスと秘密情報はマスクされます。",
      ...
      doctorFixConfirmCodex: "本アプリが Codex 設定の [features].hooks を true にします。続行しますか？",
      doctorFixConfirmCodexTitle: "Codex hooks を有効にしますか？",
      doctorFixConfirmCodexDetail: "この修復は Codex 設定を変更し、[features].hooks を true にします。ここで確認するまで、本アプリはこの変更を行いません。",
      doctorFixConfirmCodexAction: "有効化して修復",
      doctorFixConfirmCancel: "キャンセル",
      doctorRestartButton: "アプリを再起動",
      doctorRestarting: "再起動中",
      doctorRestartConfirmTitle: "アプリを再起動しますか？",
      doctorRestartConfirmDetail: "アプリを終了して再起動します。進行中の AI coding agent リクエストは切断されます。再起動中は設定ウィンドウも閉じます。",
      ...
      shortcutLabelTogglePet: "Pet表示/非表示",
      ...
      rowAgentPermissionsDesc: "オフにすると、このエージェントは アプリの吹き出しではなく自身のターミナル上でプロンプトを処理します。",
      rowCodexPermissionMode: "Codex 権限モード",
      rowCodexPermissionModeDesc: "Native は Codex AutoReview とターミナルの標準プロンプトに任せます。Intercept は アプリの許可/拒否吹き出しを表示します。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      ...
      rowSoundDesc: "アプリがタスクを完了したとき、または入力を求めたときに音を再生します。",
      rowVolume: "音量",
      rowVolumeDesc: "効果音の音量を調整します。効果音オフの時は無効になります。",
      rowLowPowerIdleMode: "省電力アイドル",
      rowLowPowerIdleModeDesc: "数秒間ペットが静止していたら idle SVG アニメーションを停止し、活動が再開すると即座に復帰します。",
      ...
      rowOpenAtLoginDesc: "ログイン時にアプリを自動起動します。",
      ...
      claudeHooksDisconnectConfirmDetail: "`~/.claude/settings.json` から アプリ管理の Claude hooks を削除し、自動管理をオフにします。`Claude Code と同時に起動` 設定は後で再有効化できるよう保持されます。",
      claudeHooksDisconnectConfirmAction: "hooks を切断",
      claudeHooksDisconnectConfirmKeep: "接続を維持",
      rowStartWithClaude: "Claude Code と同時に起動",
      rowStartWithClaudeDesc: "Claude Code セッションが開始するたびに アプリを自動起動します。",
      rowStartWithClaudeDisabledDesc: "Claude hooks の自動管理が必要です。管理がオフの間はポート変更や設定上書きが自動修復されません。",
      rowHideBubbles: "吹き出しを非表示",
      rowHideBubblesDesc: "アプリの権限・通知・アップデート吹き出しをまとめて非表示にします。",
      rowBubbleFollow: "吹き出しがペットに追従",
      ...
      updateBubbleDisableConfirmDetail: "アップデートエラーの原因・ダウンロード完了通知・再起動プロンプトを見逃す可能性があります。アップデート処理自体は継続しますが、アプリは吹き出しを表示しません。",
      ...
      placeholderDesc: "このパネルは 今後のアプリリリースで追加されます。計画は docs/plans/plan-settings-panel.md にあります。",
      toastSaveFailed: "保存できませんでした: ",
      langSystem: "システム言語に従う",
      langEnglish: "English",
      langChinese: "简中",
      langTraditionalChinese: "繁中",
      langKorean: "한국어",
      langJapanese: "日本語",
      themeTitle: "テーマ",
      themeSubtitle: "ペットのテーマを選びます。カードには組み込み・能力バッジが表示されるので、tracked / static / mini の違いを切替前に確認できます。",
      ...
      themeImportUserThemeZip: "ペットテーマパッケージをインポート（.zip）",
      themeImportUserThemeZipHint: "ペットテーマ zip: ルートまたは 1 つのトップフォルダに theme.json が必要です。SVG、GIF、APNG、PNG、WebP、JPG、JPEG は assets/ に入れてください。Codex Pet パッケージは上の入口を使います。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet を更新しました: 新規 ${imported}、更新 ${updated}、変更なし ${unchanged}、削除 ${removed}${invalid ? `、無効 ${invalid}` : ""}${switched ? "、使用中テーマをデフォルトに戻しました" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `"${name}" をアンインストールしました${switched ? "。デフォルトテーマに戻しました" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `インポート済みペットをアンインストールできませんでした: ${message}`,
      animMapTitle: "アニメーションマップ",
      animMapSubtitle: "個別の割り込みアニメーションをオフにできます。イベント自体は発火しますが、アプリは選択した状態の表示と効果音をスキップします。",
      ...
      minicpmTitle: "MiniCPM",
      minicpmSubtitle: "ローカルの MiniCPM モデルを設定します。",
      minicpmIpcUnavailable: "MiniCPM IPC を利用できません（preload が読み込まれていません）。",
      minicpmSectionBehavior: "動作",
      minicpmSectionModel: "モデル",
      minicpmSectionAdvanced: "詳細設定",
      minicpmRowNarration: "ペットのナレーション",
      minicpmRowNarrationDesc: "Cursor / Claude / Codex のイベント発生時、ペットがローカルモデルで話します。",
      minicpmRowDefaultThinking: "デフォルト思考モード",
      minicpmRowDefaultThinkingDesc: "オンにすると、新しい会話でデフォルトで思考モードを使用します。応答時間とローカルリソース使用量が増加します。",
      minicpmRowBackend: "推論バックエンド",
      minicpmRowBackendDesc: "Windows は安定した CPU が既定です。Vulkan は実験的で、失敗時は CPU に自動復帰します。",
      minicpmBackendCpu: "CPU",
      minicpmBackendVulkan: "Vulkan",
      minicpmBackendMetal: "Metal",
      minicpmBackendVulkanExperimental: "実験的 GPU バックエンド",
      minicpmBackendVulkanFallback: "Vulkan の起動に失敗したため CPU に戻しました。",
      minicpmRowModelInfo: "モデル",
      minicpmRowModelPath: "パス",
      minicpmModelPathUnset: "モデル未選択",
      minicpmOpenModelPath: "Finder に表示",
      minicpmOpenModelDirFailed: "モデルフォルダを開けませんでした。",
      minicpmChangeModel: "変更…",
      minicpmChangeModelBusy: "読み込み中…",
      minicpmReloadError: "モデルの読み込みに失敗: ",
      minicpmStatusRunning: "実行中",
      minicpmStatusStarting: "起動中",
      minicpmStatusError: "エラー",
      minicpmActionRestartSidecar: "Sidecar を再起動",
      minicpmActionRestartSidecarDesc: "モデル / アクセラレータの変更を適用",
      minicpmActionRestartSidecarBusy: "再起動中…",
      minicpmActionOpenLogs: "ログフォルダを開く",
      minicpmActionOpenLogsDesc: "Sidecar / llama の起動問題を調査",
      minicpmActionOpenLogsFailed: "ログフォルダを開けませんでした。",
      minicpmSectionAdapter: "ペルソナ LoRA",
      minicpmRowAdapter: "アクティブ LoRA",
      minicpmRowAdapterDesc: "ペルソナを選択。ナレーションは常にベースモデルを使用します。",
      minicpmAdapterBase: "Base",
      minicpmAdapterEmpty: "adapters フォルダに .gguf がまだありません。",
      minicpmAdapterOpenDir: "保存フォルダを開く",
      minicpmAdapterRefresh: "更新",
      minicpmAdapterApplying: "切り替え中…",
      minicpmAdapterApplyFailed: "LoRA 切り替えに失敗: ",
      minicpmAdapterOpenDirFailed: "adapters フォルダを開けませんでした。",
      minicpmAdapterUpload: "LoRA アップロード",
      minicpmAdapterUploadFailed: "LoRA アップロード失敗: ",
      minicpmAdapterDisplayNameLabel: "表示名",
      minicpmAdapterDisplayNamePlaceholder: "例: 猫娘 ばおばお",
      minicpmAdapterAliasesLabel: "エイリアス (カンマ区切り)",
      minicpmAdapterAliasesPlaceholder: "例: 猫娘, ばおばお, neko",
      minicpmAdapterEditName: "名前・エイリアス編集",
      minicpmAdapterRemove: "削除",
      minicpmAdapterRemoveConfirm: "この LoRA を削除しますか？対応する .gguf も削除されます。",
      minicpmAdapterMissingTag: "ファイル消失",
      minicpmAdapterSaveFailed: "保存失敗: ",
      minicpmAdapterSave: "保存",
      minicpmAdapterCancel: "キャンセル",
      ...
      aboutEasterEggToast: "ローカル AI、いつもデスクの上に。",
  ...
  const CONTRIBUTORS = [
    ...
    "Hwasowl", "XiangZheng2002", "keiyo118", "pan93412",
  ];
